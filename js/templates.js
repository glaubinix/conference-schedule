(function (root, factory) {
    ...
    templatizer["schedule"]["talk"] = function tmpl_schedule_talk() {
        return '<div class="talk"><h2 role="time"></h2><div><h3 class="talk-headline"><span role="speaker"></span><span> - </span><span role="topic"></span></h3><div>Location: <span role="location"></span></div><div class="hidden description"><span role="description"></span><div><span class="star-button">star</span></div></div></div></div>';
    };
